  ...
  return (
    <div className="m-2 md:m-10 p-2 md:p-10 bg-white dark:bg-gray-800 rounded-xl">
      ...
      <div className=" flex items-center justify-center">
        <div className="bg-white w-fit p-3 rounded-xl text-2xl mx-10" >
          <Latex>{exp1}</Latex>
        </div>
        <div className="bg-white flex w-fit p-3 rounded-xl text-2xl mx-10">
          <Latex>{exp2}</Latex>
        </div>
        <div className="bg-white flex w-fit p-3 rounded-xl text-2xl mx-10">
          <Latex>{exp3}</Latex>
      ...
      <div className=" flex items-center justify-center">
      <div className="bg-white flex w-fit p-3 rounded-xl text-2xl">
        <Latex>{exp4}</Latex>
      </div>
      </div>
      <br />< br />
